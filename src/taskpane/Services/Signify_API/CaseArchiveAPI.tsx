...
const AccountArchiveAPI = (parent_id) => {
            ...
            if (result.status === Office.AsyncResultStatus.Succeeded) {
                ...
                fetch(`${API_URL}set_entry`, requestOptions)
                    ...
                    .then((result) => {
                        ...
                        const caseOutput = jsonData.data;
                        const jsonCaseId = JSON.parse(caseOutput);
                        const CaseArchiveId = jsonCaseId.id;


                        getCaseArchiveID(CaseArchiveId)
...
export const getCaseArchiveID = (CaseArchiveId) => {
    const API_URL = CRM_Url()
    const LoginToken = CRM_Token()
