...
import OpportunityList from '../../components/SignifyCRM_UI/SignifyCRM_Lists/OpportunityList';
...
const SearchOpportunity = ({ name, setLoading }) => {
    ...
    return (
        <div>
            <OpportunityList opportunities={opportunities} totalCount={totalCount} />
        </div>
    );
}
