...
import { CalendarAccountList } from '../../Calendar_UI/CalendarSignify_List/CalendarAccountList';
import { GetUserData } from '../../../Oauth/GetUserData';
import CRM_Token from '../../../Oauth/CRM_Token';
import CRM_Url from '../../../Hooks/CRM_Url';

const CalendarSearchAccount = ({ name, email, setLoading }) => {
    ...
    return (
        <div>
            <CalendarAccountList accounts={accounts} totalCount={totalCount} />
        </div>
    );
}

export default CalendarSearchAccount;
