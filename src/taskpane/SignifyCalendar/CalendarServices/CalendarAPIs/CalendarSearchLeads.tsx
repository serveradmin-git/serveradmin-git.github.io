...
import CalendarLeadList from '../../Calendar_UI/CalendarSignify_List/CalendarLeadList';


const CalendarSearchLeads = ({ name, email, setLoading }) => {
    ...
    return (
        <div>
            <CalendarLeadList leads={leads} totalCount={totalCount} />
        </div>
    );
}

export default CalendarSearchLeads;
